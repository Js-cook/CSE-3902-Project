...
namespace _3902_Project
{
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            //enemyMasterSpriteFactory.LoadContent(Content, _spriteBatch);
            //enemyFactory = new EnemyFactory(_graphics, enemyMasterSpriteFactory); // TODO: ideally we decouple graphics from this
            ...
            //gameState = new DemoState(_spriteBatch);
            ...
            keyboardController = new KeyboardController(player, roomManager, enemyController, this, itemController, gameState);
        }
