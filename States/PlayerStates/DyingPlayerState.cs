...
public class DyingPlayerState : AbstractDyingPlayer
{
    private Link player;
    ...
    public DyingPlayerState(Link player, PlayerSpriteFactory spriteFactory, ProjectileController projectileController, Dictionary<string, SoundEffect> soundEffect)
    {
        this.player = player;
        ...
        audioController.PlaySoundEffect(soundEffect["PlayerDying"]);
    }
