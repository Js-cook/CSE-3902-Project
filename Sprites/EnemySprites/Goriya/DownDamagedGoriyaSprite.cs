...
using System;
public class DownDamagedGoriyaSprite : ISprite
{
    ...
    private Rectangle sourceRectangle2 = new Rectangle(222, 28, 16, 16);
    private int frameCounter = 0;

    public DownDamagedGoriyaSprite(Texture2D texture, Vector2 position, SpriteBatch spriteBatch, Enums.Direction currDirection)
    {
