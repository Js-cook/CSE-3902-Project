...
public class DiamondLockedDoorSprite : BaseTile
{
    ...
    private Rectangle sourceRectangleTop = new Rectangle(914, 11, 32, 32);
    private Rectangle sourceRectangleBottom = new Rectangle(914, 110, 32, 32);
    private Rectangle sourceRectangleLeft = new Rectangle(914, 44, 32, 32);
    private Rectangle sourceRectangleRight = new Rectangle(914, 77, 32, 32);

    public DiamondLockedDoorSprite(Texture2D texture, SpriteBatch spriteBatch, int direction)
    {
