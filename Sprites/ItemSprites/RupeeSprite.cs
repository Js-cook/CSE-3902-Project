...
namespace Sprites
{
    public class RupeeSprite : BaseItem
    {
        private Texture2D texture;
        private SpriteBatch spriteBatch;

        private Rectangle frame1 = new Rectangle(72, 0, 8, 16);
        private Rectangle frame2 = new Rectangle(72, 16, 8, 16);
        private Rectangle currentFrame;

        private int frameCounter = 0;

        public RupeeSprite(Texture2D texture, SpriteBatch spriteBatch)
        {
