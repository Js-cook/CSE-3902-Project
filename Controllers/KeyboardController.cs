...
namespace Controllers
{
    public class KeyboardController : Interfaces.IController
    {
        ...
        public KeyboardController(Link player, RoomManager roomManager, EnemyController enemyController, Game gameInstance, ItemController itemController, IGameState gameState)
        {
            //this.player = player;
